...
typedef ExprList LValueArg;
typedef ExprList CaseValueList;
...
typedef std::map<clang::CXXRecordDecl *, std::set<clang::CXXMethodDecl *>> ClassToMethodsMap;
...
public:
	SymbolTable(
      ...
      LValueArg *l_value_arg_list,
      CaseValueList *case_value_list,
      LineToVarsMap *line_to_vars_map,
      LineToConstsMap *line_to_consts_map,
      ClassToMethodsMap *cla_to_methods_map,
  ...
  LValueArg* getLValueArgList();
  CaseValueList* getCaseValueList();
  LineToVarsMap* getLineToVarMap();
  LineToConstsMap* getLineToConstsMap();
  ClassToMethodsMap* getClassToMethodsMap();
...
private:
  ...
  LValueArg *l_value_arg_list_;
  CaseValueList *case_value_list_;

  LineToVarsMap *line_to_vars_map_;
  LineToConstsMap *line_to_consts_map_;

  ClassToMethodsMap *cla_to_methods_map_;
