...
SymbolTable::SymbolTable(
	...
	l_value_arg_list_(l_value_arg_list),
	case_value_list_(case_value_list),
	line_to_vars_map_(line_to_vars_map),
	line_to_consts_map_(line_to_consts_map),
	cla_to_methods_map_(cla_to_methods_map),
...
LValueArg* SymbolTable::getLValueArgList()
{
	return l_value_arg_list_;
}

CaseValueList* SymbolTable::getCaseValueList()
{
	return case_value_list_;
}
...
ClassToMethodsMap* SymbolTable::getClassToMethodsMap(){
	return cla_to_methods_map_;
}
